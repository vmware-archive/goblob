...
var _ = Describe("S3Store", func() {
	...
	testsToRun("Multi-part", config, controlBucket, blobstore.NewS3(minioAccessKey, minioSecretKey, region, s3Endpoint, true, true, "some-buildpacks", "some-droplets", "some-packages", "some-resources"))
	testsToRun("non Multi-part", config, controlBucket, blobstore.NewS3(minioAccessKey, minioSecretKey, region, s3Endpoint, false, true, "some-buildpacks", "some-droplets", "some-packages", "some-resources"))
})
