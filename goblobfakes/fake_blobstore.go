...
func (fake *FakeBlobstore) List() ([]*goblob.Blob, error) {
	fake.listMutex.Lock()
...
func (fake *FakeBlobstore) ListReturns(result1 []*goblob.Blob, result2 error) {
	fake.ListStub = nil
...
func (fake *FakeBlobstore) Read(src *goblob.Blob) (io.ReadCloser, error) {
	fake.readMutex.Lock()
...
func (fake *FakeBlobstore) ReadArgsForCall(i int) *goblob.Blob {
	fake.readMutex.RLock()
	defer fake.readMutex.RUnlock()
...
func (fake *FakeBlobstore) Checksum(src *goblob.Blob) (string, error) {
...
func (fake *FakeBlobstore) ChecksumArgsForCall(i int) *goblob.Blob {
	fake.checksumMutex.RLock()
	defer fake.checksumMutex.RUnlock()
...
func (fake *FakeBlobstore) Write(dst *goblob.Blob, src io.Reader) error {
...
func (fake *FakeBlobstore) WriteArgsForCall(i int) (*goblob.Blob, io.Reader) {
	fake.writeMutex.RLock()
	defer fake.writeMutex.RUnlock()
...
func (fake *FakeBlobstore) Exists(arg1 *goblob.Blob) bool {
...
func (fake *FakeBlobstore) ExistsArgsForCall(i int) *goblob.Blob {
	fake.existsMutex.RLock()
	defer fake.existsMutex.RUnlock()
...
var _ goblob.Blobstore = new(FakeBlobstore)
